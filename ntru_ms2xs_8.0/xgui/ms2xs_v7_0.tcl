...
proc update_PARAM_VALUE.p { PARAM_VALUE.p MODELPARAM_VALUE.Std } {
	# Procedure called to update p when any of the dependent parameters in the arguments change
	
	set p ${PARAM_VALUE.p}
	set  ${MODELPARAM_VALUE.}
	set values() [get_property value $]
...
proc update_PARAM_VALUE.q { PARAM_VALUE.q MODELPARAM_VALUE.Std } {
