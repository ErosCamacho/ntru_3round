...
proc init_gui { IPINST } {
  ...
  set qe [ipgui::add_param $IPINST -name "qe" -parent ${Parameters}]
  set_property tooltip {qe} ${qe}
  ipgui::add_param $IPINST -name "max_cycles" -parent ${Parameters}
...
proc update_PARAM_VALUE.max_cycles { PARAM_VALUE.max_cycles } {
	# Procedure called to update max_cycles when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.max_cycles { PARAM_VALUE.max_cycles } {
	# Procedure called to validate max_cycles
	return true
}
...
proc update_PARAM_VALUE.qe { PARAM_VALUE.qe } {
	# Procedure called to update qe when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.qe { PARAM_VALUE.qe } {
	# Procedure called to validate qe
	return true
}
...
proc update_MODELPARAM_VALUE.qe { MODELPARAM_VALUE.qe PARAM_VALUE.qe } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.qe}] ${MODELPARAM_VALUE.qe}
}

proc update_MODELPARAM_VALUE.max_cycles { MODELPARAM_VALUE.max_cycles PARAM_VALUE.max_cycles } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.max_cycles}] ${MODELPARAM_VALUE.max_cycles}
}
