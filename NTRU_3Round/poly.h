...
#define poly_Sq_mul_DBG CRYPTO_NAMESPACE(poly_Sq_mul_DBG)
#define poly_Sq_mul_HW CRYPTO_NAMESPACE(poly_Sq_mul_HW)
#define poly_Rq_mul CRYPTO_NAMESPACE(poly_Rq_mul)
#define poly_Rq_mul_DBG CRYPTO_NAMESPACE(poly_Rq_mul_DBG)
#define poly_S3_mul CRYPTO_NAMESPACE(poly_S3_mul)
#define poly_S3_mul_DBG CRYPTO_NAMESPACE(poly_S3_mul_DBG)
#define poly_S3_mul_HW CRYPTO_NAMESPACE(poly_S3_mul_HW)
